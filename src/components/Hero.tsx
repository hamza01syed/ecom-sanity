    ...
    <section className='mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8'>
        <div className="flex mb-8 flex-wrap justify-between md:mb-16">
            <div className="flex w-full mb-6 flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
                <h1 className='text-4xl mb-4 font-bold text-black sm:text-5xl md:text-6xl md:mb-8 '>Top fashion for top price</h1>
            ...
            <div className="flex mb-12 w-full md:mb-16 lg:w-2/3 ">
                <div className="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
                        <Image src={urlFor(data.image1).url()} alt="image" priority width={500} height={500} className="h-full w-full object-cover object-center"/>
                </div>
                <div className="overflow-hidden rounded-lg bg-gray-100 shadow-lg ">
                        <Image src={urlFor(data.image2).url()} alt="image" priority width={500} height={500} className="h-full w-full object-cover object-center"/>
                </div>
            </div>
        </div>
